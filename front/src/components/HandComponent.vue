    ...
    <section class="draft">
        <section class="container">
            ...
            <section class="hand">
                ...
                <div class="hand-box box">
                    <h2>Card 2</h2>
                    <img :alt="hand[1].name" v-if="hand[1]" v-on:click.right="showCard(hand[1].image)" @click="playCard(hand[1])" class="hand-box__card" :src="hand[1].image">
                </div>
                <div class="hand-box box">
                    <h2>Card 3</h2>
                    <img  :alt="hand[2].name" v-if="hand[2]" v-on:click.right="showCard(hand[2].image)" @click="playCard(hand[2])" class="hand-box__card --third" :src="hand[2].image">
                </div>
            </section>
            <section class="draw">
